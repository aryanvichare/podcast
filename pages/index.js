  ...
  return (
    <div>
      ...
      <div className="flex-col bg-primary h-screen">
        ...
        <div className="flex flex-row pl-20 my-20">
          <div className="flex-row">
            <p className="text-8xl font-bold text-white inline pr-4">
              Make podcasts accessible <br />
              for
            </p>
            <p className="text-8xl font-bold text-white bg-highlight rounded  inline-block p-1">
              everyone
            </p>
            <p className="text-3xl text-white my-5">- No exception.</p>
            <button
      ...
      <div className="flex flex-col items-center">
        ...
        {/* Translate section */}
        <div className="m-10 mt-20 w-4/5 flex flex-row items-center justify-center">
          <div className="w-1/3">
        ...
        {/* Bookmark section */}
        <div className="m-10 mt-20 w-4/5 flex flex-row items-center justify-center mb-48">
          <div className="">
            <h1 className="text-4xl font-bold text-primary px-2 py-3 w-auto mt-10 mb-2 text-center">
              Bookmark Snippets
            </h1>
